...
export const HeroCarousel = () => {
  ...
  return (
    <div 
      ref={ref}
      className="relative h-[280px] md:h-[380px] lg:h-[450px] overflow-hidden bg-muted"
    >
          ...
          >
            ...
            >
              <Link to="/search">
                <Button 
                  size="lg" 
                  className="bg-white text-foreground hover:bg-white/90 font-bold rounded-full px-8 shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300"
                >
                  Shop Now
                </Button>
              </Link>
