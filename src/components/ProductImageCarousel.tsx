        ...
        {totalImages > 1 && (
          <>
            <button
              ...
              className="absolute left-2 top-1/2 -translate-y-1/2 bg-background/90 backdrop-blur-sm shadow-lg rounded-full p-2 opacity-0 group-hover:opacity-100 transition-all hover:bg-background hover:scale-110"
