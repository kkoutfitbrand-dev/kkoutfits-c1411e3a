...
// Glowing lamp effect
const GlowingLamp = ({ x, delay }: { x: number; delay: number }) => (
  <motion.div
    ...
    <section ref={ref} className="relative overflow-hidden">
      <div className="relative min-h-[500px] md:min-h-[600px]">
        ...
        <div 
          ...
          style={{ backgroundImage: `url(${pongalBanner})` }}
        >
          ...
          <div className="max-w-2xl py-12">
            ...
            >
              <div className="relative inline-block">
                ...
                <div className="relative bg-gradient-to-r from-orange-600 via-amber-500 to-yellow-500 text-white px-5 py-3 rounded-lg font-bold text-base md:text-lg shadow-2xl">
                  <div className="flex items-center gap-2">
                    <Gift className="w-5 h-5" />
                    <span>Pongal Special – Up to 50% OFF</span>
                    <Gift className="w-5 h-5" />
                  </div>
                </div>
              </div>
            ...
            >
              <Link to="/shop">
                <Button 
                  size="lg" 
                  className="group relative overflow-hidden bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white font-bold px-8 py-6 text-lg rounded-full shadow-[0_0_30px_rgba(251,146,60,0.4)] transition-all duration-300 hover:shadow-[0_0_50px_rgba(251,146,60,0.6)]"
                >
